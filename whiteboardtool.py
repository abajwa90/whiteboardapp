# create function to choose color in modal 
import tkinter as tk 

from tkinter.colorchooser import askcolor

# create function to enable drawing
def start_drawing(event):
    global is_drawing, prev_x, prev_y
    is_drawing = True
    prev_x, prev_y = event.x, event.y

# create function to draw on whiteboard
def draw(event):
    global is_drawing, prev_x, prev_y
    if is_drawing:
...
# create function to stop drawing on whiteboard
...
# create slider for line width function
